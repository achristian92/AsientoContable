@if($user->email !== 'aruiz@tavera.pe')
    <tr>
        ...
        <td>{{ $user->present()->amountCustomers() }}</td>
        ...
        <td class="text-right">
            <div class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    <a href="{{ route('admin.users.notify', $user->id) }}" class="dropdown-item" type="button">Enviar credencial</a>
