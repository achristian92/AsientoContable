                                    ...
                                    <tr>
                                        <td>
                                            <small style="color: rgba(68,69,71,0.79);">
                                                ...
                                                <a href="{{ $setting->url_login }}">{{ $setting->url_login }}</a>
                                            </small>
